    ...
    <>
      ...
      <div className="fixed top-0 right-0 w-full sm:max-w-[450px] h-screen bg-white z-1999 flex flex-col shadow-[-4px_0_30px_rgba(0,0,0,0.2)] animate-slideInRight">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-white">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 m-0">Shopping Cart</h2>
            {cartItems.length > 0 && (
          ...
          <button 
            className="w-10 h-10 flex items-center justify-center bg-transparent border-0 cursor-pointer rounded-lg text-gray-600 transition-all duration-200 hover:bg-gray-100 hover:text-gray-900" 
            onClick={onClose} 
        ...
        <div className="flex-1 overflow-y-auto flex flex-col bg-gray-50">
          {cartItems.length === 0 ? (
            <div className="flex-1 flex flex-col items-center justify-center py-16 px-6 text-center">
              ...
              <button 
                className="px-8 py-3 text-sm font-semibold rounded-lg border-2 border-gray-300 cursor-pointer bg-white text-gray-700 transition-all duration-200 hover:border-amber-500 hover:text-amber-600 hover:bg-amber-50" 
                onClick={onClose}
              >
                Continue Shopping
              </button>
            ...
            <>
                      ...
                      <div className="flex gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between gap-2 mb-2">
                            <div className="flex-1 min-w-0">
                              <h3 className="text-base font-semibold text-gray-900 m-0 truncate">{item.name}</h3>
                              <p className="text-sm text-gray-600 m-0 mt-0.5">{item.variant}</p>
                            </div>
                            <button
                              className="w-10 h-10 flex items-center justify-center bg-transparent border-0 cursor-pointer rounded-md text-gray-400 transition-all duration-200 hover:bg-red-50 hover:text-red-600 flex-shrink-0 touch-manipulation"
                          ...
                          <div className="flex items-center justify-between mt-3">
                            <div className="flex items-center gap-3">
                              <div className="flex items-center gap-2 border border-gray-300 rounded-lg bg-white">
                                <button
                                  className="w-10 h-10 flex items-center justify-center bg-transparent border-0 cursor-pointer rounded-l-lg text-gray-600 transition-all duration-200 hover:bg-gray-100 hover:text-gray-900 touch-manipulation"
                                ...
                                <button
                                  className="w-10 h-10 flex items-center justify-center bg-transparent border-0 cursor-pointer rounded-r-lg text-gray-600 transition-all duration-200 hover:bg-gray-100 hover:text-gray-900 touch-manipulation"
                                  onClick={() => handleQuantityChange(item.id, item.variant, item.quantity + 1)}
              ...
              <div className="p-6 border-t-2 border-gray-200 bg-white shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <button 
                    className="w-full py-3 px-6 text-sm font-medium rounded-lg border-2 border-gray-300 cursor-pointer bg-white text-gray-700 transition-all duration-200 hover:border-gray-400 hover:bg-gray-50" 
                    onClick={onClose}
                  >
                    Continue Shopping
                  </button>
